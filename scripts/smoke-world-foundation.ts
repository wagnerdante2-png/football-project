...
console.log(`[smoke-foundation] confederations=${snapshot.confederations.length} · nationalTeams=${snapshot.nationalTeams.length} · competitions=${snapshot.competitions.length} · rankings=${rankings.entries.length} · fixtures=${world.fixtures.length} · OK`);
