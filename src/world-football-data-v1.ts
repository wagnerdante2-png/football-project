...
export function footballClubRecords(w:World):readonly ClubRecord[]{return[...store(w).clubs.values()]}
export function footballMembershipRecords(w:World):readonly MembershipRecord[]{return[...store(w).memberships]}
export function footballHistoricalMatchRecords(w:World):readonly HistoricalMatchRecord[]{return[...store(w).matches]}
export function footballTitleRecords(w:World):readonly TitleRecord[]{return[...store(w).titles]}
