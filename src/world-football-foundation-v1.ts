...
import { seedAllNationalTeams } from './national-team-registry-seed-all-v1';
...
export function seedFootballGovernanceFoundation(world:World){for(const c of confeds)registerConfederation(world,c);const global=seedAllNationalTeams(world);return{confederations:confeds.length,associations:global.associations,nationalTeams:global.nationalTeams,historicalNationalTeams:global.historical,currentNationalTeams:global.current}}
