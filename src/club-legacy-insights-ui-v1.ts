...
function scheduleInject(){queueMicrotask(inject)}
document.addEventListener('touchline:view-rendered',e=>{if((e as CustomEvent).detail?.view==='club')scheduleInject()});
const app=document.querySelector('#app');
if(app)new MutationObserver(()=>scheduleInject()).observe(app,{subtree:true,childList:true});
